...
# Variant markers for multi-variant domains
...
def plot_global_with_selected(df_all, df_sel):
    ...
    fig.write_html(str(plots_dir / "selected_pages_metrics.html"), include_plotlyjs="cdn")
    fig.write_image(str(plots_dir / "selected_pages_metrics.jpg"), scale=2)
    print(f"Wrote {plots_dir / 'selected_pages_metrics.html'}")
